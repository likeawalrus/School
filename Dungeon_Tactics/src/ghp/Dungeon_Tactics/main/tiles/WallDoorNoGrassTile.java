...
public class WallDoorNoGrassTile extends Tile{

	String doormaplink;
	
	public WallDoorNoGrassTile (ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.wallDoorNoGrassTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

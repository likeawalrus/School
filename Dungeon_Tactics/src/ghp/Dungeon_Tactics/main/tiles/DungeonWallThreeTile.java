...
public class DungeonWallThreeTile extends Tile{

	public DungeonWallThreeTile(ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.dungeonWallThreeTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

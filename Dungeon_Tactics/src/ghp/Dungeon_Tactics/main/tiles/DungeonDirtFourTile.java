...
public class DungeonDirtFourTile extends Tile{

	public DungeonDirtFourTile(ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.dungeonDirtFourTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

...
public class WaterTGBottomTile extends Tile{

	public WaterTGBottomTile(ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.waterTGBottomTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

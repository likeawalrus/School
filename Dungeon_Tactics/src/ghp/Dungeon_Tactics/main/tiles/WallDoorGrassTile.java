...
public class WallDoorGrassTile extends Tile{

	public WallDoorGrassTile (ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.wallDoorGrassTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

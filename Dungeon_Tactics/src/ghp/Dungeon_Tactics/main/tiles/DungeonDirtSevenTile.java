...
public class DungeonDirtSevenTile extends Tile{

	public DungeonDirtSevenTile(ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.dungeonDirtSevenTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

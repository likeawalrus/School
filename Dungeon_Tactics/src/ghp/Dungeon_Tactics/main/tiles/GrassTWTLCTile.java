...
public class GrassTWTLCTile extends Tile{

	public GrassTWTLCTile(ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.grassTWTLCTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);

...
public class DungeonDirtOneTile extends Tile{

	public DungeonDirtOneTile(ImageManager imgMan) {
	...
	public void render(Graphics brush, int x , int y) {
		brush.drawImage(imgMan.dungeonDirtOneTile, x , y , Game.TILESIZE * Game.SCALE, Game.TILESIZE * Game.SCALE, null);
